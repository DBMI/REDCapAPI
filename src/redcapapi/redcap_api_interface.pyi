...
class REDCapInterface:
    ...
    def last_record_number(self, except_for: Union[int, list, None] = ..., number_desired: int = ...) -> Union[int, list]: ...
    def next_record_number(self) -> int: ...
    def retrieve(self, record_numbers: Union[int, list, None] = ..., expanded_record: bool = ...) -> pandas.DataFrame: ...
